const BOT_TOKEN = '8940120225:AAHONShsV1iwDRYIiqciNovNQoB4OyvFqhQ';
const ADMIN_CHAT_ID = '1625251103';
...
export async function handleSendOrder(payload) {
...
export async function handleBotWebhook(update) {
